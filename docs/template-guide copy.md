...
This template includes configuration files for Claude Code:

- **`CLAUDE.md`** (root) — repo-wide instructions with full-stack workflow, common commands, and AI-assisted development workflow
- **`backend/CLAUDE.md`** — backend architecture rules and conventions (three-layer architecture, async patterns, testing)
- **`frontend/CLAUDE.md`** — frontend architecture rules and conventions (React Query patterns, API layer, component organization)

These files guide Claude Code to generate code that follows the project's established patterns and conventions.
